...
export const ProblemSection: React.FC = () => {
  return (
    <section id="problem-solution" className="py-20 bg-slate-900 text-slate-50 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight uppercase">
            ...
            <span className="text-orange-500 underline decoration-4 underline-offset-4">Why Standard SEO Fails Connecticut Businesses</span>
          </h2>
          <p className="text-slate-300 text-base sm:text-lg leading-relaxed text-left sm:text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Pillar 1 */}
          <div className="bg-slate-950 rounded-lg p-8 border border-slate-800 hover:border-orange-600/70 transition duration-300 flex flex-col justify-between group shadow-2xl">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-sm bg-orange-600/20 border border-orange-500/30 flex items-center justify-center text-orange-400 group-hover:scale-105 transition">
                <Target className="w-6 h-6" />
              </div>
              <div className="text-[10px] font-bold uppercase tracking-widest text-orange-500">Pillar 1 • Core Proximity</div>
          ...
          <div className="bg-slate-950 rounded-lg p-8 border border-slate-800 hover:border-orange-600/70 transition duration-300 flex flex-col justify-between group shadow-2xl">
            <div className="space-y-4">
              ...
              <div className="text-[10px] font-bold uppercase tracking-widest text-orange-500">Pillar 2 • Map Pack Power</div>
              <h3 className="text-xl sm:text-2xl font-black text-white group-hover:text-orange-400 transition tracking-tight">
          ...
          <div className="bg-slate-950 rounded-lg p-8 border border-slate-800 hover:border-orange-600/70 transition duration-300 flex flex-col justify-between group shadow-2xl">
            <div className="space-y-4">
              ...
              <div className="text-[10px] font-bold uppercase tracking-widest text-orange-500">Pillar 3 • Entity Authority</div>
              <h3 className="text-xl sm:text-2xl font-black text-white group-hover:text-orange-400 transition tracking-tight">
        ...
        <div className="mt-12 p-6 rounded-md bg-slate-950 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-sm bg-orange-600/20 flex items-center justify-center text-orange-400 shrink-0">
              <TrendingUp className="w-5 h-5" />
            </div>
            <div>
              <div className="font-black text-white text-sm sm:text-base uppercase tracking-tight">Connecticut Search Volume Reality</div>
              <div className="text-xs text-slate-400">
                Over 2,280+ monthly high-intent searches occur in Connecticut for localized SEO services alone.
              </div>
            </div>
          </div>
          <div className="text-xs font-mono text-orange-400 bg-orange-950/80 border border-orange-800/80 px-4 py-2 rounded-sm whitespace-nowrap font-bold">
