...
export const ProofSection: React.FC<ProofSectionProps> = ({ onOpenAudit }) => {
  ...
  return (
    <section id="performance-proof" className="py-20 bg-white text-slate-900 border-t border-slate-200 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight uppercase">
            ...
            <span className="text-blue-600 underline decoration-4 underline-offset-4">Geo-Grid Dominance Across Connecticut</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 bg-slate-50 rounded-lg border border-slate-200 p-6 sm:p-8 shadow-2xl relative">
            ...
            <div className="bg-white rounded-lg border border-slate-200/80 p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between text-xs font-mono text-slate-500 pb-4">
                ...
                {/* Grid Legend */}
                <div className="mt-4 pt-4 border-t border-slate-200/80 flex items-center justify-between text-[11px] font-mono text-slate-500">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
              ...
              <button
                onClick={onOpenAudit}
                className="text-blue-600 hover:text-orange-500 font-bold uppercase tracking-tight transition cursor-pointer flex items-center gap-1"
              >
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="space-y-3">
              <div className="text-[10px] font-mono font-bold uppercase tracking-widest text-blue-600">
            ...
            <div className="pt-2">
              <button
                onClick={onOpenAudit}
                className="w-full py-4 rounded-sm bg-orange-500 hover:bg-orange-600 text-white font-black text-xs sm:text-sm uppercase tracking-tight shadow-xl shadow-orange-500/30 transition cursor-pointer flex items-center justify-center gap-2"
              >
