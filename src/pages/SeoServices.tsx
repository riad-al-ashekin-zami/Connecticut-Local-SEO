    ...
    <>
      ...
      <section className="pt-32 pb-24 bg-white text-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="bg-orange-500/10 border border-blue-600/20 px-4 py-2 w-fit mx-auto mb-8 rounded-full">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight text-slate-900 mb-8 leading-[1.1]">
            Connecticut <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">SEO Services</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-slate-50 hover:bg-slate-100 text-slate-900 font-black px-8 py-4 uppercase tracking-tight text-sm rounded-sm border border-slate-700 transition-all hover:border-orange-500/50"
            >
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white p-8 md:p-10 rounded-sm border border-slate-200 shadow-2xl relative overflow-hidden">
              <div className="absolute -top-12 -right-12 p-4 opacity-5">
                <ShieldCheck className="w-48 h-48 text-blue-600" />
              </div>
              <h3 className="text-2xl font-black uppercase tracking-tight text-slate-900 mb-6 relative z-10">The Cost of Invisibility</h3>
      ...
      {/* Deep Dive: Local SEO */}
      <section className="py-24 bg-white border-t border-slate-200" id="local-seo">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-1/3">
              <div className="sticky top-32">
                <div className="w-16 h-16 bg-orange-500/10 border border-blue-600/20 rounded-sm flex items-center justify-center mb-6">
            ...
            <div className="lg:w-2/3 space-y-8">
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Google Business Profile (GBP) Management</h3>
              ...
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Hyper-Local Relevance & Citations</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
              ...
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Review Velocity & Reputation Management</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
              ...
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Geo-Grid Tracking & Proximity Expansion</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200" id="technical-seo">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row-reverse gap-16">
            ...
            <div className="lg:w-2/3 space-y-8">
              <div className="bg-white border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Crawlability & Indexation Diagnostics</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
              ...
              <div className="bg-white border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Core Web Vitals & Performance Engineering</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
              ...
              <div className="bg-white border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Advanced Schema Markup (JSON-LD)</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
              ...
              <div className="bg-white border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Information Architecture & URL Structuring</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
      ...
      <section className="py-24 bg-white border-t border-slate-200" id="content-seo">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-1/3">
              <div className="sticky top-32">
            ...
            <div className="lg:w-2/3 space-y-8">
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">High-Intent Keyword Research</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
              ...
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Service Page Optimization</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
              ...
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Service-Area & Location Pages</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
              ...
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase text-slate-900 mb-3">Topic Clusters & Informational Content</h3>
                <p className="text-slate-500 leading-relaxed mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-sm border border-slate-200">
              ...
              <h3 className="text-2xl font-black uppercase tracking-tight text-slate-900 mb-4">Authority & Link Building</h3>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-600 text-sm leading-relaxed"><strong>Local Link Acquisition:</strong> Securing links from Connecticut chambers of commerce, regional news outlets, and local sponsorships.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span className="text-slate-600 text-sm leading-relaxed"><strong>Industry Relevance:</strong> Earning links from trade associations, vendor directories, and niche-specific publications.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span className="text-slate-600 text-sm leading-relaxed"><strong>Toxic Link Audits:</strong> Identifying and disavowing malicious or spammy backlinks that may be suppressing your search visibility.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-sm border border-slate-200">
              ...
              <h3 className="text-2xl font-black uppercase tracking-tight text-slate-900 mb-4">Comprehensive SEO Audits</h3>
              <p className="text-slate-500 leading-relaxed mb-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span className="text-slate-600 text-sm leading-relaxed"><strong>Penalty Diagnostics:</strong> Determining if you have been hit by an algorithmic update or a manual action by Google.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span className="text-slate-600 text-sm leading-relaxed"><strong>Competitor Tear-Downs:</strong> Reverse-engineering the exact content and link strategies your top 3 local competitors are using.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                  <span className="text-slate-600 text-sm leading-relaxed"><strong>Actionable Roadmaps:</strong> We turn audit data into a prioritized, month-by-month execution plan based on impact and effort.</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm text-center">
              ...
              <h3 className="text-lg font-bold uppercase text-slate-900 mb-2">Qualified Organic Traffic</h3>
              <p className="text-slate-500 text-sm">We measure the increase in users visiting your site specifically for your high-value commercial terms, excluding irrelevant or out-of-state traffic.</p>
            </div>
            <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm text-center">
              <div className="w-12 h-12 rounded-full bg-emerald-500/10 flex items-center justify-center mx-auto mb-4">
                <BarChart3 className="w-6 h-6 text-emerald-400" />
              </div>
              <h3 className="text-lg font-bold uppercase text-slate-900 mb-2">Geo-Grid Dominance</h3>
              <p className="text-slate-500 text-sm">We provide visual heatmaps showing exactly how your Map Pack rankings are expanding block-by-block across your target Connecticut municipalities.</p>
            </div>
            <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm text-center">
              <div className="w-12 h-12 rounded-full bg-emerald-500/10 flex items-center justify-center mx-auto mb-4">
                <Crosshair className="w-6 h-6 text-emerald-400" />
              </div>
              <h3 className="text-lg font-bold uppercase text-slate-900 mb-2">Lead Conversion Tracking</h3>
              <p className="text-slate-500 text-sm">We deploy advanced call tracking and form attribution so you know exactly which SEO efforts generated which phone calls and booked appointments.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">How much do your SEO services cost?</h3>
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">How long does SEO take to see results?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">What is included in a monthly SEO campaign?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">Do I need local SEO or national SEO?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">Will I have to sign a long-term contract?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">How do you track and measure SEO results?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">Can SEO help a small business compete with larger corporations?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">Do you provide technical SEO for complex website platforms?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
