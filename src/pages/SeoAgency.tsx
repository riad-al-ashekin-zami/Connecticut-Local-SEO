        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-black uppercase tracking-tight text-slate-900 mb-6 leading-[1.05]">
                An Elite <span className="text-blue-600">SEO Agency</span> Focused on Connecticut
              </h1>
              ...
              <button
                onClick={openAudit}
                className="bg-orange-500 hover:bg-orange-600 text-white font-black text-sm uppercase tracking-tight px-8 py-4 rounded-sm transition shadow-lg shadow-orange-500/30 flex items-center gap-2 group w-full sm:w-auto justify-center"
              >
            ...
            <div className="relative mt-8 lg:mt-0">
              ...
              <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm relative shadow-2xl">
                <h3 className="text-2xl font-black uppercase tracking-tight text-slate-900 mb-6">Agency Capabilities</h3>
                <ul className="space-y-6 text-sm text-slate-600">
                  <li className="flex items-start gap-4">
                    <Database className="w-6 h-6 text-blue-600 shrink-0" />
                    <div>
                      <strong className="text-slate-900 block text-base mb-1 uppercase tracking-tight">Enterprise Technical SEO</strong>
                      <span className="text-slate-500">Deep crawling, architecture restructuring, and advanced JSON-LD schema nesting.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <Target className="w-6 h-6 text-blue-600 shrink-0" />
                    <div>
                      <strong className="text-slate-900 block text-base mb-1 uppercase tracking-tight">Multi-Location Scaling</strong>
                      <span className="text-slate-500">Systematic Map Pack dominance engineered across multiple CT municipalities.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <Building2 className="w-6 h-6 text-blue-600 shrink-0" />
                    <div>
                      <strong className="text-slate-900 block text-base mb-1 uppercase tracking-tight">Entity Establishment</strong>
                      <span className="text-slate-500">Solidifying local brand authority in Google's Knowledge Graph via PR and citations.</span>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white border border-slate-200 p-8 rounded-sm opacity-75">
              <h3 className="text-xl font-bold uppercase text-slate-900 mb-4">The Freelancer</h3>
            ...
            <div className="bg-white border border-slate-200 p-8 rounded-sm opacity-75">
              <h3 className="text-xl font-bold uppercase text-slate-900 mb-4">The In-House Hire</h3>
              <p className="text-slate-500 text-sm leading-relaxed mb-6">
            ...
            <div className="bg-orange-500/5 border border-orange-500/30 p-8 rounded-sm shadow-[0_0_30px_-15px_rgba(234,88,12,0.3)]">
              <div className="flex items-center gap-2 mb-4">
                <ShieldAlert className="w-5 h-5 text-blue-600" />
                <h3 className="text-xl font-bold uppercase text-slate-900">The Specialized Agency</h3>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-slate-50 p-6 rounded-sm border border-slate-200">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-2 uppercase tracking-tight">Full Execution</h3>
                <p className="text-sm text-slate-500">We don't just consult. We implement the code, write the content, and build the links ourselves.</p>
              </div>
              <div className="bg-slate-50 p-6 rounded-sm border border-slate-200">
                <LineChart className="w-8 h-8 text-blue-600 mb-4" />
                <h3 className="text-lg font-bold text-slate-900 mb-2 uppercase tracking-tight">Proactive Strategy</h3>
                <p className="text-sm text-slate-500">We constantly monitor Google's algorithm updates and adjust our tactics before your rankings drop.</p>
              </div>
              <div className="bg-slate-50 p-6 rounded-sm border border-slate-200 sm:col-span-2 flex items-start gap-4">
                <Users2 className="w-8 h-8 text-blue-600 shrink-0" />
                <div>
                  <h3 className="text-lg font-bold text-slate-900 mb-2 uppercase tracking-tight">Seamless Communication</h3>
                  <p className="text-sm text-slate-500">Direct access via Slack/email, scheduled strategy calls, and detailed video walkthroughs of your monthly performance data.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white border border-slate-200 p-6 rounded-sm hover:border-orange-500/50 transition-all relative group">
                ...
                <h3 className="text-lg font-bold uppercase text-slate-900 mb-3 relative z-10 mt-8 tracking-tight">{phase.title}</h3>
                <p className="text-slate-500 text-sm relative z-10">{phase.desc}</p>
              </div>
            ))}
          </div>
        </div>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex flex-col lg:flex-row gap-16 items-center">
             <div className="lg:w-1/2">
                <ShieldAlert className="w-16 h-16 text-blue-600 mb-6" />
                <h2 className="text-3xl lg:text-4xl font-black uppercase tracking-tight text-slate-900 mb-6">Built for Scaling Multi-Location Businesses</h2>
                <p className="text-slate-600 text-lg leading-relaxed mb-6">
                  Whether you are a plumbing company expanding your service routes to <Link to="/local-seo-waterford-ct/" className="text-blue-600 hover:underline">Waterford</Link> or a law firm trying to establish total market dominance in <Link to="/seo-new-haven-ct/" className="text-blue-600 hover:underline">New Haven</Link>, our agency provides the firepower required to unseat entrenched competitors.
                </p>
                ...
                <button
                  onClick={openAudit}
                  className="bg-orange-500 hover:bg-orange-600 text-white font-black text-sm uppercase tracking-tight px-8 py-4 rounded-sm transition shadow-lg shadow-orange-500/30 inline-flex items-center gap-2"
                >
             ...
             <div className="lg:w-1/2">
               <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm">
                 <h3 className="text-xl font-bold text-slate-900 mb-6 uppercase tracking-tight">Agency Integration</h3>
                 <ul className="space-y-4">
                   <li className="flex items-start gap-3">
                     <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                     <span className="text-slate-600 text-sm">We handle all technical heavy lifting; your team approves content.</span>
                   </li>
                   <li className="flex items-start gap-3">
                     <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                     <span className="text-slate-600 text-sm">We integrate our lead tracking with your CRM (HubSpot, GoHighLevel, ServiceTitan).</span>
                   </li>
                   <li className="flex items-start gap-3">
                     <CheckCircle2 className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
                     <span className="text-slate-600 text-sm">We provide white-label reporting options if you are a complementary marketing agency looking for an SEO partner.</span>
                   </li>
                 </ul>
               </div>
             </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">Do you work with our internal marketing team?</h3>
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">How does an agency differ from a consultant?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                A <Link to="/seo-consultant-connecticut/" className="text-blue-600 hover:underline">consultant</Link> typically provides analysis, strategy, and recommendations, leaving the actual implementation to you. As an agency, we provide the strategy and then perform the actual labor—writing the code, producing the content, and building the links.
              </p>
            </div>

            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">What size businesses do you typically work with?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-slate-900 uppercase tracking-tight mb-3">Do you outsource your SEO work?</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
