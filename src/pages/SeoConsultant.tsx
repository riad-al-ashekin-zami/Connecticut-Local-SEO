    ...
    <>
      ...
      <section className="pt-32 pb-24 bg-slate-950 text-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="mx-auto w-16 h-16 bg-slate-900 border border-slate-800 rounded-full flex items-center justify-center mb-8 shadow-lg">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight text-white mb-6 leading-[1.1]">
            Connecticut <span className="text-orange-500">SEO Consultant</span>
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-slate-400 leading-relaxed">
                If you already employ an internal marketing director, a capable team of content writers, or a dedicated web development agency, you don't need to pay an outside firm to write blog posts or push code. What you are missing is the <strong className="text-white">technical blueprint</strong>. 
              </p>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="lg:w-1/2">
              <div className="bg-slate-950 border border-slate-800 p-8 rounded-sm">
                <h3 className="text-xl font-bold uppercase tracking-tight text-white mb-6">Ideal Candidates for Consulting:</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-slate-900 p-8 rounded-sm border border-slate-800">
              <Stethoscope className="w-10 h-10 text-orange-500 mb-6" />
              <h3 className="text-xl font-bold uppercase tracking-tight text-white mb-4">Surgical Technical Audits</h3>
            ...
            <div className="bg-slate-900 p-8 rounded-sm border border-slate-800">
              ...
              <h3 className="text-xl font-bold uppercase tracking-tight text-white mb-4">Actionable SEO Roadmaps</h3>
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
            ...
            <div className="bg-slate-900 p-8 rounded-sm border border-slate-800">
              <Map className="w-10 h-10 text-orange-500 mb-6" />
              <h3 className="text-xl font-bold uppercase tracking-tight text-white mb-4">Local SEO & Map Pack Strategy</h3>
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
            ...
            <div className="bg-slate-900 p-8 rounded-sm border border-slate-800">
              <TerminalSquare className="w-10 h-10 text-orange-500 mb-6" />
              <h3 className="text-xl font-bold uppercase tracking-tight text-white mb-4">In-House Team Training</h3>
              <p className="text-slate-400 text-sm leading-relaxed mb-6">
      ...
      <section className="py-24 bg-slate-900 border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 mt-4">How we integrate with your team to deliver results.</p>
          </div>
          
          <div className="relative border-l-2 border-slate-800 ml-4 md:ml-8 space-y-12">
            <div className="relative pl-8 md:pl-12">
              <div className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-orange-600 ring-4 ring-slate-900"></div>
              <h3 className="text-xl font-bold text-white uppercase tracking-tight mb-2">1. Discovery & Goal Alignment</h3>
            ...
            <div className="relative pl-8 md:pl-12">
              <div className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-orange-600 ring-4 ring-slate-900"></div>
              <h3 className="text-xl font-bold text-white uppercase tracking-tight mb-2">2. Deep Technical & Competitive Audit</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="relative pl-8 md:pl-12">
              <div className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-orange-600 ring-4 ring-slate-900"></div>
              <h3 className="text-xl font-bold text-white uppercase tracking-tight mb-2">3. Roadmap Delivery & Team Handoff</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="relative pl-8 md:pl-12">
              ...
              <h3 className="text-xl font-bold text-white uppercase tracking-tight mb-2">4. Fractional Retainer (Optional)</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-slate-900 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">Do you implement the changes on my website?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
                Under a consulting agreement, no. We provide the strategy, the audit, and the roadmap. Your internal team or web developer is responsible for the actual implementation. If you do not have an internal team to execute the work, you should explore our <Link to="/seo-agency-connecticut/" className="text-orange-400 hover:underline">Full-Service Agency</Link> option.
              </p>
            </div>
            
            <div className="bg-slate-900 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">How much does an SEO audit cost?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">Can you help us recover from a Google Penalty?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
