      ...
      <section className="pt-32 pb-24 bg-slate-950 text-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight text-white mb-8 leading-[1.1]">
            The Premier <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">SEO Company</span> in Connecticut
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-slate-950 p-6 rounded-sm border border-slate-800">
                ...
                <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">Technical Execution</h3>
                <p className="text-sm text-slate-400 leading-relaxed">SEO requires modifying server configurations, rendering paths, and complex JSON-LD schema that general marketers rarely understand.</p>
              </div>
              <div className="bg-slate-950 p-6 rounded-sm border border-slate-800">
                <Target className="w-8 h-8 text-orange-500 mb-4" />
                <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">Algorithmic Insight</h3>
                <p className="text-sm text-slate-400 leading-relaxed">Google updates its algorithm thousands of times per year. We dedicate our careers to studying these shifts so you don't have to.</p>
              </div>
              <div className="bg-slate-950 p-6 rounded-sm border border-slate-800">
                <Activity className="w-8 h-8 text-orange-500 mb-4" />
                <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">Resource Allocation</h3>
                <p className="text-sm text-slate-400 leading-relaxed">We utilize enterprise-grade crawling, tracking, and auditing software that is prohibitively expensive for a single local business to license.</p>
              </div>
              <div className="bg-slate-950 p-6 rounded-sm border border-slate-800">
                <Focus className="w-8 h-8 text-orange-500 mb-4" />
                <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">Focus on Operations</h3>
                <p className="text-sm text-slate-400 leading-relaxed">Partnering with an SEO company allows you to focus on fulfilling the leads we generate, rather than worrying about your website's indexing status.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="w-16 h-16 shrink-0 rounded-full bg-slate-900 border border-orange-500/30 flex items-center justify-center text-2xl font-black text-orange-500 shadow-[0_0_15px_-3px_rgba(234,88,12,0.4)]">
                1
              </div>
              <div>
                <h3 className="text-2xl font-bold uppercase tracking-tight text-white mb-3">Discovery & Strategic Alignment</h3>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                <h3 className="text-2xl font-bold uppercase tracking-tight text-white mb-3">Forensic Technical & Competitive Analysis</h3>
                <p className="text-slate-400 leading-relaxed mb-4">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                <h3 className="text-2xl font-bold uppercase tracking-tight text-white mb-3">Architecture & Execution</h3>
                <p className="text-slate-400 leading-relaxed mb-4">
                  We fix the technical foundation first, ensuring maximum crawl efficiency and speed. Then, we execute the <Link to="/seo-services-connecticut/" className="text-orange-400 hover:underline">content strategy</Link>, building out dedicated service pages and highly localized service-area pages. We optimize your Google Business Profile for maximum Map Pack visibility and begin the ongoing process of acquiring authoritative local backlinks to push your domain authority above the competition.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div>
                <h3 className="text-2xl font-bold uppercase tracking-tight text-white mb-3">Iterative Optimization</h3>
                <p className="text-slate-400 leading-relaxed mb-4">
      ...
      <section className="py-24 bg-slate-900 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-slate-950 p-8 rounded-sm border border-slate-800 relative">
              ...
              <h3 className="text-xl font-bold text-white mb-6 mt-4">The Standard Agency Model</h3>
            ...
            <div className="bg-orange-600/5 p-8 rounded-sm border border-orange-500/30 relative shadow-[0_0_30px_-15px_rgba(234,88,12,0.3)]">
              ...
              <h3 className="text-xl font-bold text-white mb-6 mt-4">Our Partnership Model</h3>
              <ul className="space-y-4">
                {[
            ...
            <div className="lg:w-1/2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-slate-900 p-6 rounded-sm border border-slate-800">
                  ...
                  <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">Strategy Calls</h3>
                  <p className="text-sm text-slate-400">Regular check-ins to align our SEO efforts with your evolving business goals and operational capacity.</p>
                </div>
                <div className="bg-slate-900 p-6 rounded-sm border border-slate-800">
                  <BarChart3 className="w-8 h-8 text-orange-500 mb-4" />
                  <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">Live Telemetry</h3>
                  <p className="text-sm text-slate-400">Access to real-time dashboards tracking phone calls, form fills, and granular local map pack rankings.</p>
                </div>
                <div className="bg-slate-900 p-6 rounded-sm border border-slate-800 sm:col-span-2">
                  <Workflow className="w-8 h-8 text-orange-500 mb-4" />
                  <h3 className="text-lg font-bold text-white mb-2 uppercase tracking-tight">Transparent Roadmaps</h3>
                  <p className="text-sm text-slate-400">You will always know exactly what we are working on, why we are doing it, and what impact we expect it to have on your bottom line.</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-slate-950 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">Do you require long-term contracts?</h3>
            ...
            <div className="bg-slate-950 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">How do you communicate with clients?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-950 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">What kind of businesses do you partner with?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-950 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">Are you a full-service marketing agency?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-950 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">How do you handle local exclusivity?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
                We do not compete against ourselves. If we partner with a personal injury lawyer in <Link to="/seo-new-haven-ct/" className="text-orange-400 hover:underline">New Haven</Link>, we will not take on another personal injury lawyer in that exact same territory. Our goal is to make our client the undisputed leader in their specific geographic market.
              </p>
            </div>

            <div className="bg-slate-950 border border-slate-800 p-6 sm:p-8 rounded-sm">
              <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-3">Do I own my website and content?</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
